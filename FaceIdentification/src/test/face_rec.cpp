...
typedef VOID (CALLBACK *RELSEASEFACEDET)(VOID);
typedef VOID (CALLBACK *RELSEASEFACEALI)(VOID);
typedef VOID (CALLBACK *RELSEASEFACEIDE)(VOID);
typedef FaceDetection * (CALLBACK *FACEDETGET)(CHAR*);
typedef FaceAlignment * (CALLBACK *FACEALIGET)(CHAR*);
typedef FaceIdentification * (CALLBACK *FACEIDEGET)(CHAR*);

RELSEASEFACEALI ReleaseAli;
RELSEASEFACEDET ReleaseDet;
RELSEASEFACEIDE ReleaseIde;
FACEDETGET GetDet;
FACEALIGET GetAli;
FACEIDEGET GetIde;
#endif
